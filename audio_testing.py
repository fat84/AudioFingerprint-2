...
class Main:
    ...
    def proses(self):
        if len(self.path) > 0:
            ...
            plt.subplots_adjust(top = 1, bottom = 0, right = 1, left = 0, 
                                hspace = 0, wspace = 0)
            plt.savefig("Spektrogram Frekuensi Testing Clean.png")
            self.resizeImg("Spektrogram Frekuensi Testing Clean.png")
            self.SpectrogramImg = Image.open("Spektrogram Frekuensi Testing Clean.png")
            self.SpectrogramImg = ImageTk.PhotoImage(self.SpectrogramImg)
            ...
            plt.subplots_adjust(top = 1, bottom = 0, right = 1, left = 0, 
                                hspace = 0, wspace = 0)
            plt.savefig("All Frekuensi Domain Testing Clean.png")
            self.resizeImg("All Frekuensi Domain Testing Clean.png")
            self.AllFreqDomImg = Image.open("All Frekuensi Domain Testing Clean.png")
            self.AllFreqDomImg = ImageTk.PhotoImage(self.AllFreqDomImg)
